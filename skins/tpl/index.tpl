                    ...
                    <tbody>
                        <tr>
                            ...
                            <td id="right_td">
                                ...
                                <a href="?<?php echo $_SERVER['QUERY_STRING']?>&amp;ln=en"><img src="language/en.png" alt="img" /></a> 
                                <a href="?<?php echo $_SERVER['QUERY_STRING']?>&amp;ln=ua"><img src="language/ua.png" alt="img" /></a>
                                <?php
